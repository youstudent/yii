...
class Qiniu extends Component
{
    ...
    const HOST_HUADONG = 'http://up-z0.qiniu.com';
    const HOST_HUABEI = 'http://up-z1.qiniu.com';
    const HOST_HUANAN = 'http://up-z2.qiniu.com';
    ...
    public function uploadFile($filePath, $key = null, $bucket = '', $region = null)
    {
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $region);
