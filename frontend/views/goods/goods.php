    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=$goods->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=$goods->logo?> "style="width: 350px;height: 350px;" alt="" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><?=\yii\helpers\Html::img('http://www.admin.com/'.$gallery->path)?></a>
                            </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="<?=\yii\helpers\Url::to(['cart/cart'])?>" method="post" class="choose">
                    <ul>
                        <li>
                            <dl>
                                <dt>购买数量：</dt>
